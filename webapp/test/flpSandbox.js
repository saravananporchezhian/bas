		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo App",
									"targetURL": "#comdemosample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemosample-display": {
								"semanticObject": "comdemosample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.sample",
									"url": sap.ui.require.toUrl("com/demo/sample")
								}
							}
						}
					}
